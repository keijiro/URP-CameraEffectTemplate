...
sealed class ColorInvertPass : ScriptableRenderPass
{
    public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
    {
        var camera = frameData.Get<UniversalCameraData>().camera;
        var controller = camera.GetComponent<ColorInvertController>();
        ...
        renderGraph.AddBlitPass(param, passName: "Color Invert");
